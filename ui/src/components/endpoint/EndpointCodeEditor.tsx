...
export default function EndpointCodeEditor({ editorMargin }: EndpointCodeEditorProps) {
  return (
    <div className="h-screen bg-white">
      <div className="h-full w-full" style={{ marginTop: editorMargin }}>
        <Editor defaultLanguage="json" defaultValue={JSON.stringify(JSON_EXAMPLE, null, 2)} />
      </div>
    </div>
  );
}
